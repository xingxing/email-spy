...
describe "Hotmail" do
  before do
    @test_data = YAML::load(File.read(File.expand_path("spec/fixture/hotmail.yml")))
    @contacts = EmailSpy.fetch(@test_data["invitor email"], @test_data["invitor password"], 'hotmail')
  end
